...
// Gray scale whitelabel
// export const gallery = '#EBEBEB'
// Gray scale
export const white = '#FFFFFF'
export const darkerWhite = '#f8f8f8'
...
// Purple scale whitelabel
export const butterflyBush = '#7254A2'
export const butterflyBushDarker = '#6454A8'
export const mediumPurple = '#9871D9'
// Purple scale
...
export const primaryGray = '#d4d4d4'
export const secondaryGray = '#8f8f8f'
export const terciaryGray = '#C4C4C4'
export const quaternaryGray = '#E5E5E5'
export const pentaneryGray = '#2B2B2B'
